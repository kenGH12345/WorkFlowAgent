...
|-------------|-------------|
| `WorkFlowAgent` | Your project name (auto-detected from directory name) |
| `WorkFlowAgent – JS project` | e.g., `Flutter I-Ching oracle app` |
| `JS` | e.g., `Flutter/Dart`, `Unity/Lua`, `Go/React` |
| `TBD` | e.g., `iOS, Android, Windows` |
| `{DIRECTORY_TREE}` | Paste your actual directory structure |
| `No single file > 600 lines` | e.g., `800 lines for .dart`, `400 lines for .js` |
| `Follow language conventions` | e.g., `PascalCase for widgets, camelCase for functions` |
| `TBD` | e.g., `StatefulWidget`, `Riverpod`, `Redux` |
